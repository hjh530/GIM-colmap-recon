...
| 方法 | 注册数 | 3D 点数 | 耗时 |
|------|--------|---------|------|
| **MASt3R** | **70 / 70** | 175,490 | ~6 min |
| gim_dkm | 54 / 70 | 40,210 | ~4 min |
| gim_lightglue | 52 / 70 | 27,948 | ~3 min |
...
| 方法 | 注册数 | 3D 点数 | 耗时 |
|------|--------|---------|------|
| **MASt3R** | **550 / 550** | 820K+ | ~45 min |
| gim_lightglue | 544 / 550 | 529,471 | ~25 min |
| gim_dkm | — | — | 失败（特征文件超 80GB） |

mast3r 再次全部注册，gim_lightglue 98.9% 也不错。gim_dkm 因为产生过量关键点导致磁盘耗尽。
...
一句话：**用学习式图像匹配增强 COLMAP，让复杂场景下的相机位姿估计更稳。**
